...
# Adding Optimism to your centralized exchange
...
2. Connect to an Optimism endpoint and send a `balanceOf` query to address `0x8700daec35af8ff88c16bdf0418774cb3d7599b4`.
...
[You can read more about this subject here](../developers/build/transaction-fees.md). The relevant code sample is [here](../../src/docs/developers/build/transaction-fees/#displaying-fees-to-users).
